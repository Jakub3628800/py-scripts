...
def test_convert_filename():
    assert convert_filename("src/module/file.py") == "tests/test_src/test_module/test_file.py"
    assert convert_filename("file.py") == "tests/test_file.py"
    assert convert_filename("deeply/nested/path/file.py") == "tests/test_deeply/test_nested/test_path/test_file.py"

@pytest.mark.parametrize("input_arg, expected_output", [
    (["script.py", "src/module/file.py"], "tests/test_src/test_module/test_file.py"),
    (["script.py", "tests/test_file.py"], "tests/test_file.py"),
